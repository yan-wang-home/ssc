...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTFORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CONTACTFORMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACTFORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACTFORM actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CONTACTFORM actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTFORM actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CONTACTFORM actions', async () => {
      const arg = 42666;
