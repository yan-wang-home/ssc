...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATECONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_RATECONFIGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RATECONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RATECONFIG actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_RATECONFIG actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_RATECONFIG actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_RATECONFIG actions', async () => {
      const arg = 42666;
