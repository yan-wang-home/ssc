        ...
        <div className="flex flex-col items-center justify-start w-full">
          <div className="flex flex-col items-center justify-start lg:mx-auto lg:px-5 w-full">
            <div className="flex bg-blue-800 sm:flex-col flex-row md:gap-10 items-center justify-between w-full">
              <div className="w-2/5 bg-blue-800 border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <Text className="lg:text-6xl md:text-3xl sm:text-xl lg:ml-10 md:ml-6 sm:ml-6 text-justify font-bold text-white-A700">
                  <Translate contentKey="product.commercialloan.title1" />
                  <br /> <Translate contentKey="product.commercialloan.title2" />
                </Text>
                <Button
                  className="cursor-pointer lg:w-1/2 md:w-3/5 sm:w-3/5 lg:ml-10 md:ml-6 sm:ml-6 lg:mt-5 md:mt-3 sm:mt-3 my-0.5 text-base text-center font-bold uppercase lg:text-lg lg:px-5 sm:text-xs w-1/3 lg:h-14 md:h-10 sm:h-10 md:px-2 sm:px-1"
                  shape="round"
                  color="red_800"
                  variant="fill"
              ...
              <div className="w-3/5 bg-white border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <Img src="content/images/commercialloan.png" className="object-fill" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-start mx-auto lg:mt-20 lg:px-5 md:mt-10 sm:mt-10 w-full">
            <div className="flex sm:flex-col h-full flex-row sm:gap-10 items-center justify-between w-full relative">
              <Img className="w-full object-cover" src="content/images/commercialloan-detail.png" alt="Background" />
              <div className="absolute top-1/2 transform -translate-y-1/2 text-white p-8 w-full">
                <Text className="lg:text-4xl md:text-xl sm:text-xl font-bold text-blue-900 lg:mb-4 lg:text-left sm:text-center backdrop-blur-sm">
                  <Translate contentKey="product.commercialloan.question" />
                </Text>
                <Text className="lg:text-2xl md:text-sm sm:text-sm text-blue-900 sm:text-center lg:mt-4 backdrop-blur-sm">
                  <Translate contentKey="product.commercialloan.answer" />
                </Text>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col bg-white-A700 items-center justify-start mx-auto w-full">
              <div className="flex sm:flex-col lg:flex-row my-5 items-center justify-between w-full relative">
                <div className="w-2/5 flex items-center justify-center ml-5">
                  <Img className="w-56" src="content/images/commercialloan-icon.png" alt="" />
                </div>
                <div className="flex flex-col w-3/5">
                  <div className="lg:mt-10 lg:mb-10 lg:mr-5">
                    ...
                    <Text className="text-2xl sm:text-lg ml-5 text-justify font-bold text-blue-800 mt-3">
                      <Translate contentKey="product.commercialloan.points.p1" />
                    </Text>
                    <Text className="text-2xl sm:text-lg ml-5 text-justify font-bold text-blue-800 mt-3">
                      <Translate contentKey="product.commercialloan.points.p2" />
                    </Text>
                    <Text className="text-2xl sm:text-lg ml-5 text-justify font-bold text-blue-800 mt-3">
                      <Translate contentKey="product.commercialloan.points.p3" />
                    </Text>
                  </div>
                </div>
              </div>
