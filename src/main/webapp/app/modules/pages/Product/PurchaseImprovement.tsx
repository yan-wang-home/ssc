...
const PurchaseImprovement: React.FC = () => {
        ...
        <div className="flex flex-col items-center justify-start w-full">
            ...
            <div className="flex bg-blue-800 sm:flex-col flex-row md:gap-10 items-center justify-between w-full">
              <div className="w-2/5 bg-blue-800 border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <Text className="lg:text-6xl md:text-3xl sm:text-xl lg:ml-10 md:ml-5 sm:ml-5 text-justify font-bold text-white-A700">
                  <Translate contentKey="product.purchaseimprovement.title1" />
                  <br /> <Translate contentKey="product.purchaseimprovement.title2" />
                </Text>
                <Button
              ...
              <div className="w-3/5 bg-white border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <Img src="content/images/purchaseimprovement.png" className="object-fill" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-start mx-auto lg:mt-20 lg:px-5 md:mt-10 sm:mt-10 w-full">
            <div className="flex sm:flex-col h-full flex-row sm:gap-10 items-center justify-between w-full relative">
              <Img className="w-full object-cover" src="content/images/purchaseimprovement-detail.png" alt="Background" />
              <div className="absolute top-1/2 transform -translate-y-1/2 text-white p-8 w-full">
                <Text className="lg:text-4xl md:text-xl sm:text-xl font-bold text-blue-900 lg:mb-4 lg:text-left sm:text-center backdrop-blur-sm">
                  <Translate contentKey="product.purchaseimprovement.question" />
                </Text>
                <Text className="lg:text-2xl md:text-sm sm:text-sm text-blue-900 sm:text-center lg:mt-4 backdrop-blur-sm">
                  <Translate contentKey="product.purchaseimprovement.answer" />
                </Text>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col bg-white-A700 items-center justify-start mx-auto w-full">
              <div className="flex sm:flex-col lg:flex-row my-5 items-center justify-between w-full relative">
                <div className="w-2/5 flex items-center justify-center ml-5">
                  <Img className="w-56" src="content/images/purchaseimprovement-icon.png" alt="" />
                </div>
                <div className="flex flex-col w-3/5">
                  <div className="mt-10 lg:mb-10 lg:mr-5">
                    ...
                    <Text className="text-2xl sm:text-lg ml-5 text-justify font-bold mt-2 text-blue-800 mt-3">
                      <Translate contentKey="product.purchaseimprovement.points.p1" />
                    </Text>
                    <Text className="text-2xl sm:text-lg ml-5 text-justify font-bold mt-2 text-blue-800 mt-3">
                      <Translate contentKey="product.purchaseimprovement.points.p2" />
                    </Text>
                    <Text className="text-2xl sm:text-lg ml-5 text-justify font-bold mt-2 text-blue-800 mt-3">
                      <Translate contentKey="product.purchaseimprovement.points.p3" />
                    </Text>
                  </div>
                </div>
              </div>
...
export default PurchaseImprovement;
