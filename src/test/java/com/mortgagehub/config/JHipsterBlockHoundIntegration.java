package com.mortgagehub.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mortgagehub.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mortgagehub.security.DomainUserDetailsService", "createSpringSecurityUser");
